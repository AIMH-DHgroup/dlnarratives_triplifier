...
import narra.triplifier.model.OWLOntologyPopulator2Nuova;
...
public class TriplifyMoreJsons {

	private static Logger log = null;	
	
	public static int countIdLAU = 0;
	...
	public static void main(String[] args) throws Exception {
        ...
        String directoryPath = "./454json2/";
        
        // Crea un oggetto File per la cartella
        File directory = new File(directoryPath);
        
        // Ottieni tutti i file nella cartella
        File[] files = directory.listFiles();
        
        // Crea un ArrayList per memorizzare i nomi dei file
        ArrayList<String> fileNames = new ArrayList<>();
        
        // Itera attraverso l'array di file e aggiungi i nomi dei file all'ArrayList
        if(files != null) {
            for (File file : files) {
                if (file.isFile()) {
        ...
        for (String fileName : fileNamesArray) {
			...
			jsonPath = directoryPath + fileName;
			...
			if (args.length > 1 && args[1] != null && !"".equals(args[1])) {
				...
				owlPath =  "./Target/454owl/" + fileName.replace(".json", "") + ".owl";
				owlPath =  "./Target/n.owl" ;
			...
			try {
				...
				if("true".equalsIgnoreCase(properties.getProperty("expanseOntology"))){
					...
					// Populate ontology
					OWLOntologyPopulator2Nuova ontoPopulator = new OWLOntologyPopulator2Nuova();
				...
				if (result > 0) {
					...
					RDFXMLDocumentFormat rdfDocFormat = ("true".equalsIgnoreCase(properties.getProperty("expandOntology")))
							...
							//local= "http://localhost:3030/provaLocale/";
							//RDFConnection conn = RDFConnection.connectPW(local,"prate","DQ2ELA8AebyQ");
							...
							//conn.delete("https://tool.dlnarratives.eu/adminNarra.1_N3176ioioioio");
							...
							//conn.delete("https://tool.dlnarratives.eu/adminNarra.1_N3183");

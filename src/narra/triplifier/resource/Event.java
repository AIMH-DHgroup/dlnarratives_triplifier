...
public class Event {
	...
	private String id3DModel;
	private String annotation3DModel;
	...
	// 3D model
	public String getId3DModel() {
		return id3DModel;
	}

	public void setId3DModel(String id3DModel) {
		this.id3DModel = id3DModel;
	}
	
	public String getAnnotation3DModel() {
		return annotation3DModel;
	}

	public void setAnnotation3DModel(String annotation3DModel) {
		this.annotation3DModel = annotation3DModel;
	}
